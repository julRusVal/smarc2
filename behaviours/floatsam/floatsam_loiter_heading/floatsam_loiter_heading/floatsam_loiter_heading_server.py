...
class LoiterActionFloatSam():
    ...
    def declare_node_parameters(self) -> None:
        ...
        self._node.declare_parameter('loiter_reposition_tolerance', 2.5, double_desc)
    ...
    def get_node_parameters(self) -> None:
        ...
        self._loiter_tolerance = self._node.get_parameter('loiter_tolerance').get_parameter_value().double_value
        self._loiter_move_to_speed = self._node.get_parameter('loiter_move_to_speed').get_parameter_value().string_value
        self._heading_tolerance = self._node.get_parameter('heading_tolerance').get_parameter_value().double_value
        self._reposition_tolerance = self._node.get_parameter('loiter_reposition_tolerance').get_parameter_value().double_value
        ...
        self._loiter_velocity_d_gain = self._node.get_parameter('velocity_d_gain').get_parameter_value().double_value
